...
import GetPostPricingResponseRenew from './GetPostPricingResponseRenew';
...
class PaymentGetPostPricingResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('renew')) {
                obj['renew'] = GetPostPricingResponseRenew.constructFromObject(data['renew']);
            }
    ...
    static validateJSON(data) {
        // validate the optional field `renew`
        if (data['renew']) { // data not null
          GetPostPricingResponseRenew.validateJSON(data['renew']);
        }
...
/**
     * @return {module:model/GetPostPricingResponseRenew}
     */
    getRenew() {
        return this.renew;
    }
    ...
    /**
     * @param {module:model/GetPostPricingResponseRenew} renew
     */
    setRenew(renew) {
        this['renew'] = renew;
    }
...
/**
 * @member {module:model/GetPostPricingResponseRenew} renew
 */
PaymentGetPostPricingResponse.prototype['renew'] = undefined;
