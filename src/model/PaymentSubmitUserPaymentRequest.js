...
class PaymentSubmitUserPaymentRequest {
     ...
     * @param profitRials {String} بخشی از مبلغ پرداختی که به شما تعلق می‌گیرد (سود یا کمیسیون)، به ریال
...
/**
     * Returns بخشی از مبلغ پرداختی که به شما تعلق می‌گیرد (سود یا کمیسیون)، به ریال
     * @return {String}
     */
    getProfitRials() {
    ...
    /**
     * Sets بخشی از مبلغ پرداختی که به شما تعلق می‌گیرد (سود یا کمیسیون)، به ریال
