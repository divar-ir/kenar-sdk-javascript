...
import AddonSemanticPaymentMethod from './AddonSemanticPaymentMethod';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payment_method')) {
                obj['payment_method'] = AddonSemanticPaymentMethod.constructFromObject(data['payment_method']);
            }
...
/**
 * @member {module:model/AddonSemanticPaymentMethod} payment_method
 */
