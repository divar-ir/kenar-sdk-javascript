...
class ChatAPIConversationSendMessageBody {
     ...
     * @param message {String} محتوای پیام متنی برای ارسال
     */
    constructor(message) { 
...
/**
     * Returns محتوای پیام متنی برای ارسال
     * @return {String}
     */
    getMessage() {
        return this.message;
    ...
    /**
     * Sets محتوای پیام متنی برای ارسال
     * @param {String} message محتوای پیام متنی برای ارسال
     */
    setMessage(message) {
