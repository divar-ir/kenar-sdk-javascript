...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KenarApiClient.PostPostGeneralData();
  });
  ...
  describe('PostPostGeneralData', function() {
    it('should create an instance of PostPostGeneralData', function() {
      // uncomment below and update the code to test PostPostGeneralData
      //var instance = new KenarApiClient.PostPostGeneralData();
      //expect(instance).to.be.a(KenarApiClient.PostPostGeneralData);
    });
