...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KenarApiClient.PaymentApi();
  });
  ...
  describe('PaymentApi', function() {
    ...
    describe('paymentPublishUserPost', function() {
      it('should call paymentPublishUserPost successfully', function(done) {
        //uncomment below and update the code to test paymentPublishUserPost
        //instance.paymentPublishUserPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('paymentRenewPost', function() {
      it('should call paymentRenewPost successfully', function(done) {
        //uncomment below and update the code to test paymentRenewPost
        //instance.paymentRenewPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
